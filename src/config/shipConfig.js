...
export const ThrusterModelConfig = Object.freeze([
  Object.freeze({ number: 1, slot: ThrusterSlot.MainBack, size: 3, energyConsumption: 3 }),
  Object.freeze({ number: 2, slot: ThrusterSlot.FrontLeft, size: 1, energyConsumption: 1 }),
  Object.freeze({ number: 3, slot: ThrusterSlot.FrontRight, size: 1, energyConsumption: 1 }),
  Object.freeze({ number: 4, slot: ThrusterSlot.TopLeft, size: 1, energyConsumption: 1 }),
  Object.freeze({ number: 5, slot: ThrusterSlot.TopRight, size: 1, energyConsumption: 1 }),
  Object.freeze({ number: 6, slot: ThrusterSlot.BottomLeft, size: 1, energyConsumption: 1 }),
...
export const GravityTestShipModelConfig = Object.freeze([
  ...
  Object.freeze({ id: "drifter-east", mass: 2, vx: -4, vy: 2, rotation: -0.35, thrusterAcceleration: 12 }),
  Object.freeze({ id: "drifter-southwest", mass: 2, vx: 3, vy: -2, rotation: 0.65, thrusterAcceleration: 12 })
]);
